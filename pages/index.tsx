        ...
        <div className="relative -mt-12 lg:-mt-24">
          <svg viewBox="0 0 1428 174" version="1.1">
            <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
              ...
              >
                <path
                  d="M0.457,34.035 C57.086,53.198 98.208,65.809 123.822,71.865 C181.454,85.495 234.295,90.29 272.033,93.459 C311.355,96.759 396.635,95.801 461.025,91.663 C486.76,90.01 518.727,86.372 556.926,80.752 C595.747,74.596 622.372,70.008 636.799,66.991 C663.913,61.324 712.501,49.503 727.605,46.128 C780.47,34.317 818.839,22.532 856.324,15.904 C922.689,4.169 955.676,2.522 1011.185,0.432 C1060.705,1.477 1097.39,3.129 1121.236,5.387 C1161.703,9.219 1208.621,17.821 1235.4,22.304 C1285.855,30.748 1354.351,47.432 1440.886,72.354 L1441.191,130 L1.121,130 L0.457,34.035 Z"
                  ref={(ref) => {
                    anime({
                      targets: ref,
                      translateY: -25,
          ...
          <div className="container mx-auto flex flex-wrap pt-4 pb-12">
            ...
            <div className="pt-6">
              {[
                ...
                <div
                  data-date={n[1]}
                  className="flex flex-row items-center before:content-[attr(data-date)] before:top-0 before:left-2 before:h-full before-w-2"
                >
                  ...
                  <div className="shrink pl-6">
                    <div className="">
                      ...
                      <p className="w-full text-gray-600 text-sm md:text-sm pb-2">
                        {n[2]}
                      </p>
                      <p className="w-full text-gray-600 text-md md:text-sm pb-4">
                        {n[3]}
                      </p>
                    </div>
                  </div>
